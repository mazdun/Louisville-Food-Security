...
**What's considered far from a grocery store:** In rural communities, far from a grocery store means more than 10 miles; in non-rural areas, it's more than 1 mile. 
...
What does the food environment look like in Louisville? Here's a breakdown of the number of grocery stores, supercenters, warehouse club stores, convenience stores, fast food restaurants and farmers markets per 100,000 people.
...
Bridging this $46 million gap in Louisville (and similar gaps in other cities) is tricky. Government programs like the Supplemental Nutrition Assistance Program (SNAP), WIC program and school meal programs help some — but far from all — of the food insecure. In 2020, Feeding America estimated that as much as *one-third* of food insecure people may not qualify for governmental food assistance. That leaves a wide swath of people that depend on the charitable sector to meet their food needs.
