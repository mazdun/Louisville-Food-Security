...
Currently, Louisville needs about \$46 million annually to meet the needs of its food insecure population, according to estimates from Feeding America. That's lower than the peer average of about \$51 million.
...
Toward the beginning of the last decade, Louisville had a larger budget shortfall than its peers, on average. Since that point, Louisville has diverged from its peers.
