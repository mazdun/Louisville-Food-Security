...
The budget shortfall has decreased over time in Louisville and its peer cities. (It's important to note, however, that the percentage of people experiencing food insecurity has also decreased over this time.) In Louisville, the food insecure need about 46 million collectively to meet their food needs. That's lower than the peer average of about 51 million.

```{r budget shortfall}

knitr::opts_chunk$set(fig.width=34, fig.height=24)
